  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "The Core Web Vitals are Largest Contentful Paint (LCP) for loading, Interaction to Next Paint (INP) for responsiveness, and Cumulative Layout Shift (CLS) for visual stability.",
        },
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Not exactly. PageSpeed Insights runs Lighthouse for its lab diagnostics, but it also displays real-world field data from the Chrome User Experience Report (CrUX) when traffic thresholds are met.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Not automatically. Animation enhances hierarchy and brand polish. The key question is whether it delays critical content or blocks user interaction. Always measure before removing.",
        },
      },
    ],
  };
